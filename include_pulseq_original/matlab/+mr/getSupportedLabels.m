...
supported_labels={'SLC','SEG','REP','AVG','SET','ECO','PHS','LIN','PAR','ACQ','NAV','REV','SMS', ... # these label values are copied to the corresponding MDH field on Siemens
    'REF', 'IMA', ... # For parallel imaging
    'NOISE', ... % noise adjust scan, for parallel imaging acceleration
