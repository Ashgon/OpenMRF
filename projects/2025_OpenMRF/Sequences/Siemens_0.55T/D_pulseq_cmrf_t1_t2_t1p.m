...
T2.exc_mode     = 'adiabatic_AHP';
T2.rfc_dur      = 2 *1e-3;    % [s]  duration of composite refocusing pulses
T2.ahp_exc_time = 3.0 *1e-3;  % [s] duration of adiabatic half passage pulse
T2.ahp_wmax     = 600 * 2*pi; % [rad/s] maximum rf amplitude of ahp pulse
