...
load('Q:/data/Pulseq/Pulseq_Workspace/mgram/250812/250812_1820/backup_250812_1820_workspace.mat'); % @Sydney: use one of the backups (e.g. t1_t2); the trajectories are the same for all sequences
