...
SPI.spoil_duration = 4 *1e-3;    % [s] time for spoiler and rewinder gradients
...
if strcmp(SPI.geo.traj_mode, 'vds')
    SPI.geo.Nvds     = 0.9;           % number of vds-spirals for sampling the kspce center
    ...
    SPI.geo.grad_lim = 0.90;          % limit of gradient field strength
