...
SPI.exc_fa_mode    = 'ramped';      % 'equal',  'ramped',  'import'  
...
if strcmp(SPI.geo.traj_mode, 'vds')
    SPI.geo.Nvds     = 3.9;           % number of vds-spirals for sampling the kspce center
    ...
    SPI.geo.grad_lim = 0.9;           % limit of gradient field strength
